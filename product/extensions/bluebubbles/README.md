...
This directory contains the **BlueBubbles external channel plugin** for CoderClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `coderclaw/plugin-sdk` helpers.
