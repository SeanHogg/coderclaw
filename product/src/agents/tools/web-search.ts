...
type WebSearchConfig = NonNullable<CoderClawConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: CoderClawConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("coderclaw configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.coderclaw.ai/tools/web",
  };
}
