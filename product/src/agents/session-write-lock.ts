...
const CLEANUP_STATE_KEY = Symbol.for("coderclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("coderclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("coderclaw.sessionWriteLockWatchdogState");
