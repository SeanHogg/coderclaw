...
/**
 * Convert an CoderClaw auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * CoderClaw stores credentials in auth-profiles.json instead. This helper
