...
function resolveAvatarSource(cfg: CoderClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CoderClawConfig, agentId: string): AgentAvatarResolution {
