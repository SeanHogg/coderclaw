...
import type { CoderClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: CoderClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: CoderClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: CoderClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: CoderClawConfig) => void;
  log: {
