...
function listConfiguredAgentIds(cfg: CoderClawConfig): string[] {
...
export function listAgentsForGateway(cfg: CoderClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CoderClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: CoderClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CoderClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: CoderClawConfig): GatewaySessionsDefaults {
