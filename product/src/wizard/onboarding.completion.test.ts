...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("coderclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "coderclaw");
