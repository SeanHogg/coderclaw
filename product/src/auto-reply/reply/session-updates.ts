...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: CoderClawConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: CoderClawConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.CODERCLAW_TEST_FAST === "1") {
