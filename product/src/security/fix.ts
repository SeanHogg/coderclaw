...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CoderClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CoderClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: CoderClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
