...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.CODERCLAW_TTS_PREFS;
      process.env.CODERCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.CODERCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: CoderClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
