...
export function applyOpencodeZenProviderConfig(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyOpencodeZenConfig(cfg: CoderClawConfig): CoderClawConfig {
