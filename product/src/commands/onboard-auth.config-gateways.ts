...
export function applyVercelAiGatewayProviderConfig(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: CoderClawConfig): CoderClawConfig {
