...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.coderclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("coderclaw hooks list")}`,
      `  ${formatCliCommand("coderclaw hooks enable <name>")}`,
      `  ${formatCliCommand("coderclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
