...
function resolveDefaultAccountId(cfg: CoderClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CoderClawConfig): boolean {
...
export function summarizeBindings(cfg: CoderClawConfig, bindings: AgentBinding[]): string[] {
