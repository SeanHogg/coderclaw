...
const resolveStorePath = vi.fn(() => "/tmp/coderclaw-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/coderclaw-discord-process-test-sessions.json");
});
