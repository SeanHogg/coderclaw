...
export const normalizePluginsConfig = (
  config?: CoderClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: CoderClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: CoderClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: CoderClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
