...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @coderclaw/voice-call -> voice-call).
...
export function discoverCoderClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".coderclaw", "extensions")];
