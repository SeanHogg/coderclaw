...
function mergeSignalAccountConfig(cfg: CoderClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: CoderClawConfig): ResolvedSignalAccount[] {
