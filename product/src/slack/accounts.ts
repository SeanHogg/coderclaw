...
function mergeSlackAccountConfig(cfg: CoderClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: CoderClawConfig): ResolvedSlackAccount[] {
