...
import type { CoderClawConfig } from "./config.js";
...
function isTelegramConfigured(cfg: CoderClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: CoderClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: CoderClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: CoderClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: CoderClawConfig): boolean {
...
function isIMessageConfigured(cfg: CoderClawConfig): boolean {
...
function isWhatsAppConfigured(cfg: CoderClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: CoderClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: CoderClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: CoderClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: CoderClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: CoderClawConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: CoderClawConfig, pluginId: string): CoderClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
