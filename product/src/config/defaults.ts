...
function resolveAnthropicDefaultAuthMode(cfg: CoderClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyTalkApiKey(config: CoderClawConfig): CoderClawConfig {
...
export function applyModelDefaults(cfg: CoderClawConfig): CoderClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyLoggingDefaults(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyContextPruningDefaults(cfg: CoderClawConfig): CoderClawConfig {
...
export function applyCompactionDefaults(cfg: CoderClawConfig): CoderClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
