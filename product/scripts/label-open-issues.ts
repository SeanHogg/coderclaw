...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "coderclaw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for CoderClaw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("CoderClaw Issue Label Audit");
