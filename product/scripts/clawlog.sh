...
show_usage() {
    cat << EOF
clawlog - CoderClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View CoderClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    CoderClaw logs flow through the macOS unified log (subsystem: ai.coderclaw).
