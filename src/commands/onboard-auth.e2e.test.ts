...
describe("writeOAuthCredentials", () => {
  ...
  it("writes auth-profiles.json under CODERCLAW_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("coderclaw-oauth-");
...
describe("setMinimaxApiKey", () => {
  ...
  it("writes to CODERCLAW_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("coderclaw-minimax-", { agentSubdir: "custom-agent" });
    lifecycle.setStateDir(env.stateDir);
