...
type PromptDefaultModelResult = { model?: string; config?: CoderClawConfig };
...
function resolveConfiguredModelRaw(cfg: CoderClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: CoderClawConfig): string[] {
...
export function applyPrimaryModel(cfg: CoderClawConfig, model: string): CoderClawConfig {
...
export function applyModelAllowlist(cfg: CoderClawConfig, models: string[]): CoderClawConfig {
  const defaults = cfg.agents?.defaults;
