...
export function listBindings(cfg: CoderClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: CoderClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CoderClawConfig) {
