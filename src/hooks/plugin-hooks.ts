...
import type { CoderClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: CoderClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: CoderClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
