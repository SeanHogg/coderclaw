...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "coderclaw-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.CODERCLAW_BUNDLED_HOOKS_DIR;
    process.env.CODERCLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.CODERCLAW_BUNDLED_HOOKS_DIR;
    } else {
      process.env.CODERCLAW_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
