...
export const A2UI_PATH = "/__coderclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__coderclaw__/canvas";

export const CANVAS_WS_PATH = "/__coderclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.coderclawCanvasA2UIAction.postMessage(...)
  // - Android: window.coderclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["coderclawCanvasA2UIAction"];
  ...
  globalThis.CoderClaw = globalThis.CoderClaw ?? {};
  globalThis.CoderClaw.postMessage = postToNode;
  globalThis.CoderClaw.sendUserAction = sendUserAction;
  globalThis.coderclawPostMessage = postToNode;
  globalThis.coderclawSendUserAction = sendUserAction;
