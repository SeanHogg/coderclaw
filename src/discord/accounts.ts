...
function mergeDiscordAccountConfig(cfg: CoderClawConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: CoderClawConfig): ResolvedDiscordAccount[] {
