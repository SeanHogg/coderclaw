...
function setSlackDmPolicy(cfg: CoderClawConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "CoderClaw";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for CoderClaw`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: CoderClawConfig, allowFrom: string[]): CoderClawConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
