...
export type ChannelAgentToolFactory = (params: { cfg?: CoderClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: CoderClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: CoderClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: CoderClawConfig }) => boolean;
  supportsCards?: (params: { cfg: CoderClawConfig }) => boolean;
