...
export function listChannelMessageActions(cfg: CoderClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: CoderClawConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: CoderClawConfig): boolean {
  for (const plugin of listChannelPlugins()) {
