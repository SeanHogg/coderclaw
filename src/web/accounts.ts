...
export function listWhatsAppAuthDirs(cfg: CoderClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CoderClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CoderClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CoderClawConfig): ResolvedWhatsAppAccount[] {
