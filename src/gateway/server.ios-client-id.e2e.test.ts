...
beforeAll(async () => {
  previousToken = process.env.CODERCLAW_GATEWAY_TOKEN;
  process.env.CODERCLAW_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "coderclaw-ios", platform: "ios" },
  { clientId: "coderclaw-android", platform: "android" },
