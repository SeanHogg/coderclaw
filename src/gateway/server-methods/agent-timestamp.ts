 ...
 *
 * @see https://github.com/coderclaw/coderclaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an CoderClawConfig.
 */
export function timestampOptsFromConfig(cfg: CoderClawConfig): TimestampInjectionOptions {
  return {
