...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.CODERCLAW_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.CODERCLAW_DISABLE_LAZY_SUBCOMMANDS);
};
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live CoderClaw docs",
    hasSubcommands: false,
    register: async (program) => {
