    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["coderclaw directory self --channel slack", "Show the connected account identity."],
          [
            'coderclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["coderclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "coderclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.coderclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
