...
function resolveExecConfig(params: { cfg?: CoderClawConfig; agentId?: string }) {
...
function resolveFsConfig(params: { cfg?: CoderClawConfig; agentId?: string }) {
  const cfg = params.cfg;
...
export function createCoderClawCodingTools(options?: {
