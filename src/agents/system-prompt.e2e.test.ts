...
describe("buildAgentSystemPrompt", () => {
  ...
  // See: https://github.com/seanhogg/coderclaw/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/seanhogg/coderclaw/issues/1897
  //          https://github.com/seanhogg/coderclaw/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/seanhogg/coderclaw/issues/3658 for the preferred approach:
