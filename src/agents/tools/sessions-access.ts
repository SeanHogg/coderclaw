...
export function resolveSessionToolsVisibility(cfg: CoderClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: CoderClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: CoderClawConfig): AgentToAgentPolicy {
