...
describe("resolveDefaultAgentWorkspaceDir", () => {
  it("uses CODERCLAW_HOME for default workspace resolution", () => {
    const dir = resolveDefaultAgentWorkspaceDir({
      CODERCLAW_HOME: "/srv/coderclaw-home",
      HOME: "/home/other",
    } as NodeJS.ProcessEnv);

    expect(dir).toBe(path.join(path.resolve("/srv/coderclaw-home"), ".coderclaw", "workspace"));
  });
});

const WORKSPACE_STATE_PATH_SEGMENTS = [".coderclaw", "workspace-state.json"] as const;
