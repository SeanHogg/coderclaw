...
function resolveWatchPaths(workspaceDir: string, config?: CoderClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CoderClawConfig }) {
