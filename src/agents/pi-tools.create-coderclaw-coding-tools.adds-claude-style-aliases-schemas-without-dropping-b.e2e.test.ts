...
describe("createCoderClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createCoderClawCodingTools({
      config,
    ...
    const anthropicTools = createCoderClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createCoderClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createCoderClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
