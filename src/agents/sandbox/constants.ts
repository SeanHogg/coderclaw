...
export const DEFAULT_SANDBOX_IMAGE = "coderclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "coderclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "coderclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "coderclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "coderclaw-sbx-browser-";
