...
export function listGoogleChatAccountIds(cfg: CoderClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: CoderClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: CoderClawConfig): ResolvedGoogleChatAccount[] {
