...
export function listMattermostAccountIds(cfg: CoderClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: CoderClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CoderClawConfig): ResolvedMattermostAccount[] {
