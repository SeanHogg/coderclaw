...
If there's a relevant docs URL, include it. If there isn't one yet, leave it out — don't link to a 404.
...
- [Vision](https://docs.coderclaw.ai/vision) — understand the project direction before proposing major changes
