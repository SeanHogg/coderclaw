...
- `fix: <summary> (coderclaw#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (coderclaw#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "coderclaw#$pr_number" || { echo "ERROR: commit subject missing coderclaw#$pr_number"; exit 1; }
