...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.coderclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".coderclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.coderclawCommand(
            subcommand: "gateway",
