...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.coderclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        CoderClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CoderClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
