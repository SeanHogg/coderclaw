...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.coderclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CoderClawConfigFile.defaultWorkspaceURL() }
