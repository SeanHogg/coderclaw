...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CoderClawPhotosLatestParams) async throws -> CoderClawPhotosLatestPayload {
        ...
        var results: [CoderClawPhotoPayload] = []
        ...
        return CoderClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CoderClawPhotoPayload
    {
