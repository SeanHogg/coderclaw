...
public typealias CoderClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias CoderClawPlatformImage = UIImage
#endif

public struct CoderClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct CoderClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: CoderClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(CoderClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct CoderClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct CoderClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [CoderClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: CoderClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [CoderClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: CoderClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(CoderClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([CoderClawChatMessageContent].self, forKey: .content) {
...
public struct CoderClawChatHistoryPayload: Codable, Sendable {
...
public struct CoderClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct CoderClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [CoderClawSessionPreviewItem]
}

public struct CoderClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [CoderClawSessionPreviewEntry]

    public init(ts: Int, previews: [CoderClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct CoderClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct CoderClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct CoderClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct CoderClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct CoderClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct CoderClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: CoderClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: CoderClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct CoderClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
