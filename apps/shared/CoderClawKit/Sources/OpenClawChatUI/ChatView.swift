...
@MainActor
public struct CoderClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: CoderClawChatViewModel
    ...
    public init(
        viewModel: CoderClawChatViewModel,
    ...
    private var visibleMessages: [CoderClawChatMessage] {
        let base: [CoderClawChatMessage]
    ...
    private func mergeToolResults(in messages: [CoderClawChatMessage]) -> [CoderClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = CoderClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: CoderClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: CoderClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: CoderClawChatMessage) -> String {
