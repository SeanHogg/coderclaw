...
# Output:
# - dist/CoderClaw.app
# - dist/CoderClaw-<version>.zip
# - dist/CoderClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/CoderClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/CoderClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/CoderClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/CoderClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/CoderClaw-$VERSION.dSYM.zip"
