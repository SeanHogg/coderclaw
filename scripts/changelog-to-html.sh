...
if [[ -z "$version_content" ]]; then
  echo "<h2>CoderClaw $VERSION</h2>"
  echo "<p>Latest CoderClaw update.</p>"
  echo "<p><a href=\"https://github.com/seanhogg/coderclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
